...
print 'There are {} available combos (dumb)'.format(len(used_combinations))

# The smart way
combos = fill_containers(eggnog_amount, containers)
print 'There are {} available combos (smart):'.format(len(combos))
