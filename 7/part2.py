...
# Get the original signal a, but without modifying the outside
# objects, which means we have to clone them
a = resolve('a', dict(signals), list(commands), 0)

print commands[signals['b']]
# Set b to that result
commands[signals['b']] = ('RAW', str(a))
print commands[signals['b']]
